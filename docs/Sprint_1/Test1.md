...
| **M2**| Der Brotlänge L sei 300.0 (float). Die Scheibendicke T sei 10.0 (float). | Rufe calculateSliceCount(300.0, 10.0) auf. | Die zurückgegebene Anzahl der Scheiben N ist 30 (int). | Systemzustand unverändert. | OK
